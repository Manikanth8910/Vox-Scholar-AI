        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground text-xl leading-relaxed max-w-2xl mx-auto">
              We're building the future of academic research — making complex papers accessible,
              interactive, and genuinely human-like.
            </p>
          </motion.div>
          ...
          >
            ...
            <h2 className="font-display text-3xl font-bold text-foreground mb-3">Our Mission</h2>
            ...
            <p className="text-muted-foreground mt-4 max-w-2xl mx-auto leading-relaxed">
              Academic papers are written for experts, but ideas deserve to reach everyone. VoxScholar
              AI bridges the gap between raw research and human understanding through AI-powered
              conversations, adaptive learning, and intelligent assistance.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
            {[
              { icon: Zap, title: "Intelligence First", desc: "Every feature is powered by state-of-the-art AI, fine-tuned for academic comprehension." },
              { icon: Users, title: "Built for Researchers", desc: "Designed with feedback from PhDs, students, and professors across 30+ universities." },
              { icon: Target, title: "Democratizing Knowledge", desc: "We believe cutting-edge research should be understandable by anyone, anywhere." },
              { icon: Zap, title: "Continuous Learning", desc: "Our AI evolves with your research journey, remembering context across all your papers." },
            ].map((value, i) => (
              <motion.div
                key={value.title}
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground mt-2">Passionate researchers and engineers</p>
          </div>
